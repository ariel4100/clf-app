...
<template>
  <v-layout class="d-block">
    ...
    <footer class="text-gray-600 body-font">
      <div v-if="false" class="container px-5 py-24 mx-auto">
      ...
      <div class="bg-gray-100">
        <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© {{ new Date().getFullYear()}} CLF ARGENTINA —
            <a href="" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">Todos los derechos reservados</a>
          </p>
          <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a href="https://www.facebook.com/CLFArgentina/?locale=es_LA" target="_blank" class="text-gray-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
              </svg>
            </a>
            <a href="https://www.facebook.com/CLFArgentina/?locale=es_LA" target="_blank" class="ml-3 text-gray-500">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
